...
\usepackage{braket,luatex85,qcircuit,here,tikz}
...
$\ex^{i(\mu-\kappa)}$を$\ex^{i\varphi}$とおけば、$\ket{\psi}$として以下のようなものを考えても一般性を失わない。
...
\newpage\section{Equivalent circuit}
\subsection{Toffoli}
\begin{minipage}{30pt}
\Qcircuit{
& \ctrl{1}    & \qw \\
...
\end{minipage}
\newpage\section{Fomula}\label{formula}
